...
function createTableau(client, Projet, demandeur) {
            ...
            <Table sx={{minWidth: 650}} aria-label="simple table">
                <TableHead>
                    <TableRow>
                        ...
                        <TableCell align="right">Type de profil</TableCell>
                        <TableCell align="right">Techno</TableCell>
                        <TableCell align="right">ETP</TableCell>
                        <TableCell align="right">Type projet</TableCell>
                        <TableCell align="right">Localisation</TableCell>
                        <TableCell align="right">Séniorité</TableCell>
